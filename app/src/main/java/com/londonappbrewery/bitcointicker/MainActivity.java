...
public class MainActivity extends Activity {
    ...
    private void letsDoSomeNetworking(final String url) {
        ...
        client.get(BASE_URL + url, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                String price = JSONparse(response);
                Log.d("Bitcoin", "Prince in " + url + ": " + price);
    ...
    private String JSONparse(JSONObject json){
        try {
            double ask = json.getDouble("ask");
            return Double.toString(ask);
        } catch (JSONException e){
            e.printStackTrace();
            Log.d("Bitcoin", "JSON error");
            return null;
        }
    }
